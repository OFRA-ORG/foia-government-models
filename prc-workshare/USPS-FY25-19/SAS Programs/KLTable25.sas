...
20May09 When subdividing activity codes into pseudo codes to the CARMM program, these are the places where they also
                will need to be added:
                        ...
                        In the excel file (ActivityCodesMaster .xls)
...
*add subdivided activity codes to mixed mail mappings (need to update);
 ...
 *-----------------------------------------------------------;
 ...
 /* OTHSERV INCL. BUSRPLY, RETRCPT, ADDRCORR, FORMS3547&3579 */
         ...
         '0090','0190',
         '0300','0100',
	     '0110','0140','0200'		='058 Other Services'  /*17Nov23 add 0200 Label Delivery*/
...
*Export KL table by route, for delivery cost model;
	proc export data=kl
    outfile = "&pathOut\KLTable&FYData..xlsx"
        dbms = xlsx replace;
run;
