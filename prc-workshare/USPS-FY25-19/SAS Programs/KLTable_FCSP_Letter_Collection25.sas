...
select (Q23E02);
 ...
 if F262 = '1060' then do;         * Subdivide First-Class SP Letters;
	  if Q16F05 NE 'Y'  and Q16B01C NE 'B' and Q16E01 NE 'C' then F262 = '1060';
	  *non-collection costs go into 1060;
      if Q16F05 =  'Y'  then F262 = '1061'; ** Handling Collection Mail;
	   else
	  if Q16B01C = 'B' then F262 = '1061';  ** Carrier is on a Collection Route;
	    else
	  if Q16E01 = 'C' then F262 = '1061';   ** AMS route number indicates Collection Route;
  end; 
 if f262 = '1061' then do;
...
run;
Data kl; set kl;
If actv = '1060' or actv = '1061' or actv = '1062' or actv = '1063' or actv = '1064' or actv = '1065' or actv = '1066';

*Export KL table by route, for delivery cost model;
proc export data=kl
    outfile = "&pathOut\KLTable_FCSP_Letter_Collection&FYData..xlsx"
	dbms = xlsx replace;
run;
